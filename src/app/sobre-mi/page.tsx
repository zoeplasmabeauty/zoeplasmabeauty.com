      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-[var(--color-zoe-muted)] max-w-2xl mx-auto leading-relaxed mt-6">
            Mi nombre es <strong className="text-[var(--color-zoe-dark)]">Zoe Pérez</strong>, cosmiatra superior con diplomado en Ciencias Estéticas, especializada en Plasma Fibroblast y tratamientos de regeneración cutánea.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
              ...
              <p className="text-sm leading-relaxed">
                El método Zoe Plasma estimula la producción natural de colágeno. Integramos Dermapen, Peelings y Exosomas para fortalecer la salud funcional de tu piel.
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
              ...
              <p className="text-sm leading-relaxed">
                Seguridad y respeto por la biología cutánea. Priorizamos técnicas no invasivas que mejoran la flacidez y textura sin agredir la identidad de tu rostro.
              </p>
            </div>

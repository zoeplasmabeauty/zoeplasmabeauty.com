...
export default function Contact() {
  return (
    ...
    // INVERSIÓN VISUAL: Removido 'bg-black text-white'. El borde separador ahora es azul tenue.
    <section id="contacto" className="scroll-mt-24 px-6 py-24 border-t border-[var(--color-zoe-blue)]/10">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          ...
          <h2 className="text-4xl font-extrabold tracking-tight text-[var(--color-zoe-dark)] sm:text-5xl">
            Ponte en <span className="text-[var(--color-zoe-blue)]">Contacto</span>
          </h2>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* INVERSIÓN VISUAL: Tarjetas blancas con hover hacia el azul de marca */}
            <a 
              href="https://wa.me/5491133850211" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex items-center gap-6 rounded-2xl border border-white/60 bg-white/80 p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-[var(--color-zoe-blue)]/30 hover:bg-white hover:shadow-md"
            >
              <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-[var(--color-zoe-blue)]/10 text-[var(--color-zoe-blue)] transition-colors group-hover:bg-[var(--color-zoe-blue)]/20">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-[var(--color-zoe-dark)]">Mensaje Directo (DM)</h3>
                <p className="mt-1 text-sm font-medium text-[var(--color-zoe-muted)]">Síguenos y escríbenos por Instagram.</p>
                <span className="mt-2 inline-block font-mono text-sm font-bold text-[var(--color-zoe-blue)] group-hover:underline">
                  @zoeplasmabeauty
                </span>
              </div>
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-[var(--color-zoe-dark)]">Correo Electrónico</h3>
                <p className="mt-1 text-sm font-medium text-[var(--color-zoe-muted)]">Para consultas detalladas o alianzas.</p>
                <span className="mt-2 inline-block font-mono text-sm font-bold text-[var(--color-zoe-blue)] group-hover:underline">
            ...
            <div className="mt-4 border-t border-[var(--color-zoe-blue)]/10 pt-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                {/* Instagram Oficial */}
                {/* INVERSIÓN VISUAL: Píldoras blancas que resaltan al azul corporativo */}
                <a 
                  href="https://www.instagram.com/zoeplasmabeauty" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 rounded-xl border border-white/60 bg-white/60 px-4 py-3 shadow-sm transition-all hover:-translate-y-1 hover:border-[var(--color-zoe-blue)]/40 hover:bg-white"
                >
                  <svg className="h-5 w-5 text-[var(--color-zoe-muted)] transition-colors group-hover:text-[var(--color-zoe-blue)]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm font-bold text-[var(--color-zoe-dark)] transition-colors group-hover:text-[var(--color-zoe-blue)]">
                    Instagram Oficial
                  </span>
                </a>
          ...
          {/* INVERSIÓN VISUAL: Tarjeta blanca unificada con sombra */}
          <div className="flex flex-col justify-between overflow-hidden rounded-3xl border border-white/60 bg-white/80 shadow-md backdrop-blur-md">
            
            {/* Bloque de Información Física */}
            <div className="p-8 md:p-10">
              <div className="mb-6 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-zoe-blue)]/10 text-[var(--color-zoe-blue)]">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Tabla de Horarios */}
              <div className="space-y-3 border-t border-[var(--color-zoe-blue)]/10 pt-8">
                <h4 className="font-mono text-sm font-bold tracking-widest text-[var(--color-zoe-blue)] uppercase">
                ...
                <div className="flex justify-between pb-2 text-sm">
                  ...
                  <span className="font-bold text-sky-500">Cerrado</span>
                </div>
              </div>
            </div>
            ...
            {/* INVERSIÓN VISUAL: El borde separador es sutil */}
            <div className="relative h-64 w-full border-t border-b border-[var(--color-zoe-blue)]/10 bg-gray-100">
              ...
              {/* Capa de degradado (pointer-events-none asegura que el mapa sea interactivo) */}
              {/* INVERSIÓN VISUAL: Degradado hacia blanco en lugar de negro */}
              <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-white via-white/40 to-transparent"></div>
            ...
            {/* INVERSIÓN VISUAL: Fondo blanco puro para que el botón azul destaque */}
            <div className="flex w-full justify-center bg-white p-6">
              <a 
                href="#agendar"
                className="inline-flex rounded-full bg-[var(--color-zoe-blue)] px-8 py-3 text-sm font-bold text-white shadow-md shadow-[var(--color-zoe-blue)]/20 transition-all hover:-translate-y-1 hover:bg-[#4375af] hover:shadow-xl"
              >
                Agendar Turno
              </a>
            </div>
